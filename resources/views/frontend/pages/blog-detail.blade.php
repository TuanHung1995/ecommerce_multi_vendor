...
@section('content')
    ...
    <!--============================
                BLOGS DETAILS START
            ==============================-->
    <section id="ecom__blog_details">
        <div class="container">
            <div class="row">
                <div class="col-xxl-9 col-xl-8 col-lg-8">
                    <div class="ecom__main_blog">
                        <div class="ecom__main_blog_img">
                            <img src="{{ asset($blog->image) }}" alt="blog" class="img-fluid w-100">
                        </div>
                        <p class="ecom__main_blog_header">
                        ...
                        <div class="ecom__comment_area">
                            ...
                            @foreach ($comments as $comment)
                                <div class="ecom__main_comment">
                                    ...
                                    <div class="ecom__comment_text replay">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-4">
                    <div class="ecom__blog_sidebar" id="sticky_sidebar">
                        <div class="ecom__blog_search">
                            <h4>search</h4>
                        ...
                        <div class="ecom__blog_post">
                            <h4>More Posts</h4>
                            @foreach ($moreBlogs as $blog)
                                <div class="ecom__blog_post_single">
                                    <a href="{{ route('blog-details', $blog->slug) }}" class="ecom__blog_post_img">
                                        <img style="height: 71px;" src="{{ asset($blog->image) }}" alt="blog"
                                            class="imgofluid w-100">
                                    </a>
                                    <div class="ecom__blog_post_text">
                                        <a
