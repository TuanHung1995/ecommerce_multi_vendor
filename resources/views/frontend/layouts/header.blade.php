<header>
    <div class="container">
        <div class="row">
            <div class="col-2 col-md-1 d-lg-none">
                <div class="ecom__mobile_menu_area">
                    <span class="ecom__mobile_menu_icon"><i class="fal fa-bars"></i></span>
                </div>
            </div>
            <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                <div class="ecom_logo_area">
                    <a class="ecom__header_logo" href="index.html">
                        <img src="{{ asset($logoSetting->logo) }}" alt="logo" class="img-fluid w-100">
                    </a>
                </div>
            </div>
            <div class="col-xl-5 col-md-6 col-lg-4 d-none d-lg-block">
                <div class="ecom__search">
            ...
            <div class="col-xl-5 col-3 col-md-3 col-lg-6">
                <div class="ecom__call_icon_area">
                    <div class="ecom__call_area">
                        <div class="ecom__call">
                            <i class="fas fa-user-headset"></i>
                        </div>
                        <div class="ecom__call_text">
                            <p>{{ $settings->contact_email }}</p>
                            <p>{{ $settings->contact_phone }}</p>
                        </div>
                    </div>
                    <ul class="ecom__icon_area">
                        ...
                        <li><a class="ecom__cart_icon" href="#"><i class="fal fa-shopping-bag"></i><span
    ...
    <div class="ecom__mini_cart">
        <h4>shopping cart <span class="ecom_close_mini_cart"><i class="far fa-times"></i></span></h4>
        <ul class="mini_cart_wrapper">
            @foreach (Cart::content() as $sidebarProduct)
                <li id="mini_cart_{{ $sidebarProduct->rowId }}">
                    <div class="ecom__cart_img">
                    ...
                    <div class="ecom__cart_text">
                        <a class="ecom__cart_title"
        ...
        <div class="mini_cart_actions {{ Cart::content()->count() == 0 ? 'd-none' : '' }}">
            ...
            <div class="ecom__minicart_btn_area">
