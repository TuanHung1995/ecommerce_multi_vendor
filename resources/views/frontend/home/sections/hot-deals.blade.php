<section id="ecom__hot_deals" class="ecom__hot_deals_2">
    <div class="container">
        <div class="ecom__hot_large_item">
            <div class="row">
                <div class="col-xl-12">
                    <div class="ecom__section_header justify-content-start">
                    ...
                    @foreach ($products as $product)
                        <div class="col-xl-3 col-sm-6 col-lg-4 {{ $key }}">
                            <div class="ecom__product_item">
                                ...
                                @endif
                                <a class="ecom__pro_link" href="{{ route('product-detail', $product->slug) }}">
                                ...
                                <div class="ecom__product_details">
                                    <a class="ecom__category" href="#">{{ $product->category->name }}</a>
        ...
        <section id="ecom__single_banner" class="home_2_single_banner">
            <div class="container">
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                    <div class="ecom__pro_details_text">
                                        ...
                                        <p class="ecom__stock_area"><span class="in_stock">in stock</span> (167 item)
                                        </p>
                                        @if (checkDiscount($product))
