                    ...
                    <div class="dashboard_content">
                        <div class="ecom__dashboard">
                            <div class="row">
                                ...
                                <div class="col-xl-2 col-6 col-md-4">
                                    <a class="ecom__dashboard_item red" href="{{ route('vendor.products.index') }}">
                                        <i class="fas fa-cart-plus"></i>
                                        <p>Total Products</p>
                                ...
                                <div class="col-xl-2 col-6 col-md-4">
                                    <a class="ecom__dashboard_item red" href="javascript:;">
                                        <i class="fas fa-cart-plus"></i>
                                        <p>Todays Earnings</p>
                                ...
                                <div class="col-xl-2 col-6 col-md-4">
                                    <a class="ecom__dashboard_item red" href="{{ route('vendor.reviews.index') }}">
                                        <i class="fas fa-cart-plus"></i>
                                        <p>Total Reviews</p>
                                ...
                                <div class="col-xl-2 col-6 col-md-4">
                                    <a class="ecom__dashboard_item red" href="{{ route('vendor.shop-profile.index') }}">
